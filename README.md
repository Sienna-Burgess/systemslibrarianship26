...
***Command Line Notes:**
	...
	- To get information about the status of apache2 and make sure it is enabled and running, use:
		systemctl status apache2
	- Text-Based Web Browser: the command line browser chosen was [elinks]. To instal, use:
		sudo apt install elinks
	- The loopback address is named localhost. There are two commands that allow us to check this:
		elinks 127.0.0.1
			or
		elinks localhost
	...
	- To see the default page outside of our VM, we need our servers public IP address, which we get from our Google Cloud Console. For this, we need the external IP address.
